...
import { RefreshIcon, UploadIcon, TrashIcon } from "@heroicons/vue/solid";
...
<template>
    ...
    <header class="py-8 hero">
        <div class="flex-col max-w-3xl text-center hero-content">
            <h1 class="text-5xl">Edit Company</h1>
        </div>
    </header>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                <FormControl>
                                    ...
                                    <div
                                        v-if="form.company_current_logo"
                                        class="flex flex-col items-start gap-2 mb-2"
                                    >
                                        <div class="relative max-w-xs">
                                            <img
                                                :src="form.company_current_logo"
                                                alt="logo preview"
                                            />
